if shared.VapeExecuted then
	...
	GuiLibrary["CreateMainWindow"] = function()
		...
		settingsbox2.Text = "Novoline"..VERSION.."  "
		...
		discordbutton.MouseButton1Click:Connect(function()
			...
			task.spawn(function()
				...
				hoverbox3.Text = "Novoline Discord set to clipboard!"
				hoverbox3.ZIndex = 5
				...
				setclipboard("https://discord.com/invite/EB3mF6uypt")
				task.wait(1)
				hoverbox3:Remove()
			end)
		end)
	...
	GuiLibrary["LoadedAnimation"] = function(enabled)
		if enabled then
			...
			GuiLibrary.CreateNotification("Novoline has loaded", inputService.TouchEnabled and GuiLibrary["GUIKeybind"] == "RightShift" and "Press the button in the top right to open GUI" or "Press "..string.upper(GuiLibrary["GUIKeybind"]).." to open GUI", 5)
		end
	end
